...
from .get_game import get_game_id, get_genre_id, get_platform_id, get_publisher_id, get_year_id, existing_genre, existing_publisher, existing_year, existing_platform, existing_game, init_bdd
...
__all__ =[
    ...
    "get_game_id", "get_genre_id", "get_platform_id", "get_publisher_id", "get_year_id", "existing_genre", "existing_publisher", "existing_year", "existing_platform", "existing_game", "init_bdd"
]